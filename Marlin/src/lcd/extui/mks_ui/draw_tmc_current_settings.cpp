...
void lv_draw_tmc_current_settings() {
  ...
  if (!uiCfg.para_ui_page) {
    ...
    #else
      MUI.page_bottom_button(scr, machine_menu.next, PARA_UI_TURN_PAGE_POS_X, PARA_UI_TURN_PAGE_POS_Y, event_handler, ID_TMC_CURRENT_DOWN);
    #endif
    //lv_big_button_create(scr, "F:/bmp_back70x40.bin", machine_menu.next, PARA_UI_TURN_PAGE_POS_X, PARA_UI_TURN_PAGE_POS_Y, event_handler, ID_TMC_CURRENT_DOWN, true);  
  }
  else {
    ...
    #else
      MUI.page_bottom_button(scr, machine_menu.previous, PARA_UI_TURN_PAGE_POS_X, PARA_UI_TURN_PAGE_POS_Y, event_handler, ID_TMC_CURRENT_UP);
    #endif
  ...
  #else
    MUI.page_bottom_button(scr, common_menu.text_back, PARA_UI_BACL_POS_X, PARA_UI_BACL_POS_Y, event_handler, ID_TMC_CURRENT_RETURN);
  #endif
